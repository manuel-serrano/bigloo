/*=====================================================================*/
/*    .../prgm/project/bigloo/5.0a/runtime/Jlib/stackwriter.java       */
/*    -------------------------------------------------------------    */
/*    Author      :  Manuel Serrano                                    */
/*    Creation    :  Wed Jan 31 21:00:51 2001                          */
/*    Last change :  Wed Apr 29 07:28:42 2026 (serrano)                */
...
public class stackwriter extends PrintWriter {
   ...
   private byte[] char_to_byte(final char[] src, final int start, final int len) {
