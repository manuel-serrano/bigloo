/*=====================================================================*/
/*    .../project/bigloo/5.0a/runtime/Jlib/output_pipe_port.java       */
/*    -------------------------------------------------------------    */
/*    Author      :  Manuel Serrano                                    */
/*    Creation    :  Tue Jun 30 14:14:16 2009                          */
/*    Last change :  Wed Apr 29 07:09:55 2026 (serrano)                */
...
/*    output_pipe_port ...                                             */
/*---------------------------------------------------------------------*/
public class output_pipe_port extends output_stream_port {
   Process process;
   Thread thread;
   
   public output_pipe_port(final byte[] cmd, final byte[] _buf)
      throws IOException {
      super(cmd);
	 ...
	 thread = new Thread(new Runnable () {
	       public void run() {
		  byte[] buf = (_buf != null && _buf.length > 80) ? _buf : new byte[ 80 ];
		  int n;
