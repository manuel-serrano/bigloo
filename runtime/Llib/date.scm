...
(module __date
   ...
   (extern  (macro c-date?::bool (::obj) "BGL_DATEP")
	...
	(wasm
		...
		($date-new "(struct.new_default $date)")
		($date-update "(struct.new_default $date)")
		($date->gmtdate! "(struct.new_default $date)")

		($date-integer->second "~0")
		($date-nanosecond "(i64.const 0)")
	    ($date-millisecond "(i64.const 0)")
	    ($date-second "(i32.const 0)")
	    ($date-minute "(i32.const 0)")
	    ($date-hour "(i32.const 0)")
	    ($date-day "(i32.const 0)")
	    ($date-wday "(i32.const 0)")
	    ($date-yday "(i32.const 0)")
	    ($date-month "(i32.const 0)")
	    ($date-year "(i32.const 0)")
	    ($date-timezone "(i64.const 0)")
	    ($date-is-dst "(i32.const 0)")
	    ($date-is-gmt "(i32.const 0)")
	    ($date-time "(i64.const 0)")

	    ($date-update-millisecond "(i64.const 0)")
	    ($date-update-second "(i64.const 0)")
	    ($date-update-minute "(i64.const 0)")
	    ($date-update-time "(i64.const 0)")
	    
	    ($date-day-name "(array.new $bstring)")
	    ($date-day-aname "(array.new $bstring)")
	    ($date-month-name "(array.new $bstring)")
	    ($date-month-aname "(array.new $bstring)")
	    
	    ($date-current-seconds "(i64.const 0)")
	    ($date-current-milliseconds "(i64.const 0)")
	    ($date-current-microseconds "(i64.const 0)")
	    ($date-current-nanoseconds "(i64.const 0)")
	    ($date-from-seconds "(struct.new_default $date)")
	    ($date-from-seconds-gmt "(struct.new_default $date)")
	    ($date-from-milliseconds-gmt "(struct.new_default $date)")
	    ($date-from-nanoseconds "(struct.new_default $date)")
	    ($date-from-milliseconds "(struct.new_default $date)")
	    ($date-to-seconds "(i64.const 0)")
	    ($date-to-nanoseconds "(i64.const 0)")
	    ($date-to-milliseconds "(i64.const 0)")
	    ($date-seconds-to-string "(array.new $bstring)")
	    ($date-seconds-to-utc-string "(array.new $bstring)")
	)
