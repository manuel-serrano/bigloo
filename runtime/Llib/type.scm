...
;*    Last change :  Wed Mar  5 08:19:59 2014 (serrano)                */
;*    -------------------------------------------------------------    */
...
(module __type
   ...
   (type
    ...
    (subtype sint8 "int8_t" (cobj))
    (subtype uint8 "uint8_t" (cobj))
    (subtype sint16 "int16_t" (cobj))
    (subtype uint16 "uint16_t" (cobj))
    (subtype sint32 "int32_t" (cobj))
    (subtype uint32 "uint32_t" (cobj))
    (subtype sint64 "int64_t" (cobj))
    ...
    (coerce obj bsint8 ($sint8?) ())
    (coerce obj buint8 ($uint8?) ())
    (coerce obj bsint16 ($sint16?) ())
    (coerce obj buint16 ($uint16?) ())
    (coerce obj bsint32 ($sint32?) ())
    (coerce obj buint32 ($uint32?) ())
    (coerce obj bsint64 ($sint64?) ())
    ...
    (coerce byte sint8 () ($byte->sint8))
    (coerce byte uint8 () ($byte->uint8))
    (coerce byte sint16 () ($byte->sint16))
    (coerce byte uint16 () ($byte->uint16))
    (coerce byte sint32 () ($byte->sint32))
    (coerce byte uint32 () ($byte->uint32))
    (coerce byte sint64 () ($byte->sint64))
    ...
    (coerce ubyte sint8 () ($ubyte->sint8))
    (coerce ubyte uint8 () ($ubyte->uint8))
    (coerce ubyte sint16 () ($ubyte->sint16))
    (coerce ubyte uint16 () ($ubyte->uint16))
    (coerce ubyte sint32 () ($ubyte->sint32))
    (coerce ubyte uint32 () ($ubyte->uint32))
    (coerce ubyte sint64 () ($ubyte->sint64))
    ...
    (coerce short sint8 () ($short->sint8))
    (coerce short uint8 () ($short->uint8))
    (coerce short sint16 () ($short->sint16))
    (coerce short uint16 () ($short->uint16))
    (coerce short sint32 () ($short->sint32))
    (coerce short uint32 () ($short->uint32))
    (coerce short sint64 () ($short->sint64))
    ...
    (coerce ushort sint8 () ($ushort->sint8))
    (coerce ushort uint8 () ($ushort->uint8))
    (coerce ushort sint16 () ($ushort->sint16))
    (coerce ushort uint16 () ($ushort->uint16))
    (coerce ushort sint32 () ($ushort->sint32))
    (coerce ushort uint32 () ($ushort->uint32))
    (coerce ushort sint64 () ($ushort->sint64))
    ...
    (coerce bint sint8 () ($bint->sint8))
    (coerce bint uint8 () ($bint->uint8))
    (coerce bint sint16 () ($bint->sint16))
    (coerce bint uint16 () ($bint->uint16))
    (coerce bint sint32 () ($bint->sint32))
    (coerce bint uint32 () ($bint->uint32))
    (coerce bint sint64 () ($bint->sint64))
    ...
    (coerce int sint8 () ($int->sint8))
    (coerce int uint8 () ($int->uint8))
    (coerce int sint16 () ($int->sint16))
    (coerce int uint16 () ($int->uint16))
    (coerce int sint32 () ($int->sint32))
    (coerce int uint32 () ($int->uint32))
    (coerce int sint64 () ($int->sint64))
    ...
    (coerce uint sint16 () ($uint->sint16))
    (coerce uint uint16 () ($uint->uint16))
    (coerce uint sint32 () ($uint->sint32))
    (coerce uint uint32 () ($uint->uint32))
    (coerce uint sint64 () ($uint->sint64))
    ...
    (coerce long sint8 () ($long->sint8))
    (coerce long uint8 () ($long->uint8))
    (coerce long sint16 () ($long->sint16))
    (coerce long uint16 () ($long->uint16))
    (coerce long sint32 () ($long->sint32))
    (coerce long uint32 () ($long->uint32))
    (coerce long sint64 () ($long->sint64))
    ...
    (coerce ulong sint8 () ($ulong->sint8))
    (coerce ulong uint8 () ($ulong->uint8))
    (coerce ulong sint16 () ($ulong->sint16))
    (coerce ulong uint16 () ($ulong->uint16))
    (coerce ulong sint32 () ($ulong->sint32))
    (coerce ulong uint32 () ($ulong->uint32))
    (coerce ulong sint64 () ($ulong->sint64))
    ...
    (coerce elong sint8 () ($elong->sint8))
    (coerce elong uint8 () ($elong->uint8))
    (coerce elong sint16 () ($elong->sint16))
    (coerce elong uint16 () ($elong->uint16))
    (coerce elong sint32 () ($elong->sint32))
    (coerce elong uint32 () ($elong->uint32))
    (coerce elong sint64 () ($elong->sint64))
    ...
    (coerce sint64 elong () ($sint64->elong))
    ...
    (coerce llong sint8 () ($llong->sint8))
    (coerce llong uint8 () ($llong->uint8))
    (coerce llong sint16 () ($llong->sint16))
    (coerce llong uint16 () ($llong->uint16))
    (coerce llong sint32 () ($llong->sint32))
    (coerce llong uint32 () ($llong->uint32))
    (coerce llong sint64 () ($llong->sint64))
    (coerce llong uint64 () ($llong->uint64))

    ;; stdint
    (coerce sint8 bsint8 () ($sint8->bsint8))
    (coerce bsint8 sint8 () ($bsint8->sint8))
    (coerce uint8 buint8 () ($uint8->buint8))
    (coerce buint8 uint8 () ($buint8->uint8))
    (coerce uint8 sint8 () ($uint8->sint8))
    (coerce sint8 uint8 () ($sint8->uint8))
    (coerce sint16 bsint16 () ($sint16->bsint16))
    (coerce bsint16 sint16 () ($bsint16->sint16))
    (coerce uint16 buint16 () ($uint16->buint16))
    (coerce buint16 uint16 () ($buint16->uint16))
    (coerce uint16 sint16 () ($uint16->sint16))
    (coerce sint16 uint16 () ($sint16->uint16))
    (coerce sint32 bsint32 () ($sint32->bsint32))
    (coerce bsint32 sint32 () ($bsint32->sint32))
    (coerce uint32 buint32 () ($uint32->buint32))
    (coerce buint32 uint32 () ($buint32->uint32))
    (coerce uint32 sint32 () ($uint32->sint32))
    (coerce sint32 uint32 () ($sint32->uint32))
    (coerce sint64 bsint64 () ($sint64->bsint64))
    (coerce bsint64 sint64 () ($bsint64->sint64))
    (coerce uint64 buint64 () ($uint64->buint64))
    (coerce buint64 uint64 () ($buint64->uint64))
    (coerce uint64 sint64 () ($uint64->sint64))
    (coerce sint64 uint64 () ($sint64->uint64))
   ...
   (extern
    ...
    (macro $sint8->bint::bint (::sint8) "BINT")
    (macro $uint8->bint::bint (::uint8) "BINT")
    (macro $sint16->bint::bint (::sint16) "BINT")
    (macro $uint16->bint::bint (::uint16) "BINT")
    (macro $sint32->bint::bint (::sint32) "BINT")
    (macro $uint32->bint::bint (::uint32) "BINT")
    (macro $sint64->bint::bint (::sint64) "BINT")
    ...
    (macro $bint->sint8::sint8 (::bint) "(int8_t)CINT")
    (macro $bint->uint8::uint8 (::bint) "(uint8_t)CINT")
    (macro $bint->sint16::sint16 (::bint) "(int16_t)CINT")
    (macro $bint->uint16::uint16 (::bint) "(uint16_t)CINT")
    (macro $bint->sint32::sint32 (::bint) "(int32_t)CINT")
    (macro $bint->uint32::uint32 (::bint) "(uint32_t)CINT")
    (macro $bint->sint64::sint64 (::bint) "(int64_t)CINT")
    ...
    (macro $ubyte->sint8::sint8 (::ubyte) "(int8_t)")
    (macro $ubyte->uint8::uint8 (::ubyte) "(uint8_t)")
    (macro $ubyte->sint16::sint16 (::ubyte) "(int16_t)")
    (macro $ubyte->uint16::uint16 (::ubyte) "(uint16_t)")
    (macro $ubyte->sint32::sint32 (::ubyte) "(int32_t)")
    (macro $ubyte->uint32::uint32 (::ubyte) "(uint32_t)")
    (macro $ubyte->sint64::sint64 (::ubyte) "(int64_t)")
    ...
    (macro $byte->sint8::sint8 (::byte) "(int8_t)")
    (macro $byte->uint8::uint8 (::byte) "(uint8_t)")
    (macro $byte->sint16::sint16 (::byte) "(int16_t)")
    (macro $byte->uint16::uint16 (::byte) "(uint16_t)")
    (macro $byte->sint32::sint32 (::byte) "(int32_t)")
    (macro $byte->uint32::uint32 (::byte) "(uint32_t)")
    (macro $byte->sint64::sint64 (::byte) "(int64_t)")
    ...
    (macro $short->sint8::sint8 (::short) "(int8_t)")
    (macro $short->uint8::uint8 (::short) "(uint8_t)")
    (macro $short->sint16::sint16 (::short) "(int16_t)")
    (macro $short->uint16::uint16 (::short) "(uint16_t)")
    (macro $short->sint32::sint32 (::short) "(int32_t)")
    (macro $short->uint32::uint32 (::short) "(uint32_t)")
    (macro $short->sint64::sint64 (::short) "(int64_t)")
    ...
    (macro $ushort->sint8::sint8 (::ushort) "(int8_t)")
    (macro $ushort->uint8::sint8 (::ushort) "(uint8_t)")
    (macro $ushort->sint16::sint16 (::ushort) "(int16_t)")
    (macro $ushort->uint16::sint16 (::ushort) "(uint16_t)")
    (macro $ushort->sint32::sint32 (::ushort) "(int32_t)")
    (macro $ushort->uint32::sint32 (::ushort) "(uint32_t)")
    (macro $ushort->sint64::sint64 (::ushort) "(int64_t)")
    (macro $ushort->uint64::sint64 (::ushort) "(uint64_t)")
    ...
    (macro $int->sint8::sint8 (::int) "(int8_t)")
    (macro $int->uint8::sint8 (::int) "(uint8_t)")
    (macro $int->sint16::sint16 (::int) "(int16_t)")
    (macro $int->uint16::sint16 (::int) "(uint16_t)")
    (macro $int->sint32::sint32 (::int) "(int32_t)")
    (macro $int->uint32::sint32 (::int) "(uint32_t)")
    (macro $int->sint64::sint64 (::int) "(int64_t)")
    (macro $int->uint64::sint64 (::int) "(uint64_t)")
    ...
    (macro $uint->sint8::sint8 (::uint) "(int8_t)")
    (macro $uint->uint8::uint8 (::uint) "(uint8_t)")
    (macro $uint->sint16::sint16 (::uint) "(int16_t)")
    (macro $uint->uint16::uint16 (::uint) "(uint16_t)")
    (macro $uint->sint32::sint32 (::uint) "(int32_t)")
    (macro $uint->uint32::uint32 (::uint) "(uint32_t)")
    (macro $uint->sint64::sint64 (::uint) "(int64_t)")
    ...
    (macro $long->sint8::sint8 (::long) "(int8_t)")
    (macro $long->uint8::uint8 (::long) "(uint8_t)")
    (macro $long->sint16::sint16 (::long) "(int16_t)")
    (macro $long->uint16::uint16 (::long) "(uint16_t)")
    (macro $long->sint32::sint32 (::long) "(int32_t)")
    (macro $long->uint32::uint32 (::long) "(uint32_t)")
    (macro $long->sint64::sint64 (::long) "(int64_t)")
    ...
    (macro $ulong->sint8::sint8 (::ulong) "(int8_t)")
    (macro $ulong->uint8::uint8 (::ulong) "(uint8_t)")
    (macro $ulong->sint16::sint16 (::ulong) "(int16_t)")
    (macro $ulong->uint16::uint16 (::ulong) "(uint16_t)")
    (macro $ulong->sint32::sint32 (::ulong) "(int32_t)")
    (macro $ulong->uint32::uint32 (::ulong) "(uint32_t)")
    (macro $ulong->sint64::sint64 (::ulong) "(int64_t)")
    ...
    (macro $long->bsint8::bsint8 (::long) "BGL_INT8_TO_BINT8")
    (macro $long->buint8::buint8 (::long) "BGL_INT8_TO_BUINT8")
    (macro $long->bsint16::bsint16 (::long) "BGL_INT16_TO_BINT16")
    (macro $long->buint16::buint16 (::long) "BGL_INT16_TO_BUINT16")
    (macro $long->bsint32::bsint32 (::long) "BGL_INT32_TO_BINT32")
    (macro $long->buint32::buint32 (::long) "BGL_INT32_TO_BUINT32")
    (macro $long->bsint64::bsint64 (::long) "BGL_INT64_TO_BINT64")
    ...
    (macro $sint8->bsint8::bsint8 (::sint8) "BGL_INT8_TO_BINT8")
    (macro $bsint8->sint8::sint8 (::bsint8) "BGL_BINT8_TO_INT8")
    (macro $uint8->buint8::buint8 (::uint8) "BGL_UINT8_TO_BUINT8")
    (macro $buint8->uint8::uint8 (::buint8) "BGL_BUINT8_TO_UINT8")
    (macro $sint16->bsint16::bsint16 (::sint16) "BGL_INT16_TO_BINT16")
    (macro $bsint16->sint16::sint16 (::bsint16) "BGL_BINT16_TO_INT16")
    (macro $uint16->buint16::buint16 (::uint16) "BGL_UINT16_TO_BUINT16")
    (macro $buint16->uint16::uint16 (::buint16) "BGL_BUINT16_TO_UINT16")
    (macro $sint32->bsint32::bsint32 (::sint32) "BGL_INT32_TO_BINT32")
    (macro $bsint32->sint32::sint32 (::bsint32) "BGL_BINT32_TO_INT32")
    (macro $uint32->buint32::buint32 (::uint32) "BGL_UINT32_TO_BUINT32")
    (macro $buint32->uint32::uint32 (::buint32) "BGL_BUINT32_TO_UINT32")
    (macro $sint64->bsint64::bsint64 (::sint64) "BGL_INT64_TO_BINT64")
    (macro $bsint64->sint64::sint64 (::bsint64) "BGL_BINT64_TO_INT64")
    (macro $uint64->buint64::buint64 (::uint64) "BGL_UINT64_TO_BUINT64")
    (macro $buint64->uint64::uint64 (::buint64) "BGL_BUINT64_TO_UINT64")
    
    (macro $uint8->sint8::sint8 (::uint8) "(int8_t)")
    (macro $sint8->uint8::uint8 (::sint8) "(uint8_t)")
    (macro $uint16->sint16::sint16 (::uint16) "(int16_t)")
    (macro $sint16->uint16::uint16 (::sint16) "(uint16_t)")
    (macro $uint32->sint32::sint32 (::uint32) "(int32_t)")
    (macro $sint32->uint32::uint32 (::sint32) "(uint32_t)")
    (macro $uint64->sint64::sint64 (::uint64) "(int64_t)")
    (macro $sint64->uint64::uint64 (::sint64) "(uint64_t)")
   ...
   (java
    (abstract-class foreign
       ...
       (method static $bint->sint8::sint8 (::bint) "BINT_TO_INT8")
       (method static $bint->uint8::uint8 (::bint) "BINT_TO_UINT8")
       (method static $bint->sint16::sint16 (::bint) "BINT_TO_INT16")
       (method static $bint->uint16::uint16 (::bint) "BINT_TO_INT16")
       (method static $bint->sint32::sint32 (::bint) "BINT_TO_INT32")
       (method static $bint->uint32::uint32 (::bint) "BINT_TO_INT32")
       (method static $bint->sint64::sint64 (::bint) "BINT_TO_INT64")
       ...
       (method static $long->sint8::sint8 (::long) "LONG_TO_INT8")
       (method static $long->uint8::uint8 (::long) "LONG_TO_INT8")
       (method static $long->sint16::sint16 (::long) "LONG_TO_INT16")
       (method static $long->uint16::uint16 (::long) "LONG_TO_INT16")
       (method static $long->sint32::sint32 (::long) "LONG_TO_INT32")
       (method static $long->uint32::uint32 (::long) "LONG_TO_INT32")
       (method static $long->sint64::sint64 (::long) "LONG_TO_INT64")
       ...
       (method static $llong->sint8::sint8 (::llong) "LLONG_TO_INT8")
       (method static $llong->uint8::uint8 (::llong) "LLONG_TO_INT8")
       (method static $llong->sint16::sint16 (::llong) "LLONG_TO_INT16")
       (method static $llong->uint16::uint16 (::llong) "LLONG_TO_INT16")
       (method static $llong->sint32::sint32 (::llong) "LLONG_TO_INT32")
       (method static $llong->uint32::uint32 (::llong) "LLONG_TO_INT32")
       (method static $llong->sint64::sint64 (::llong) "LLONG_TO_INT64")
       (method static $llong->uint64::uint64 (::llong) "LLONG_TO_INT64")

       (method static $sint8->bsint8::bsint8 (::sint8) "BGL_INT8_TO_BINT8")
       (method static $bsint8->sint8::sint8 (::bsint8) "BGL_BINT8_TO_INT8")
       (method static $uint8->buint8::buint8 (::uint8) "BGL_INT8_TO_BINT8")
       (method static $buint8->uint8::uint8 (::buint8) "BGL_BINT8_TO_INT8")
       (method static $sint16->bsint16::bsint16 (::sint16) "BGL_INT16_TO_BINT16")
       (method static $bsint16->sint16::sint16 (::bsint16) "BGL_BINT16_TO_INT16")
       ...
       (method static $sint32->bsint32::bsint32 (::sint32) "BGL_INT32_TO_BINT32")
       (method static $bsint32->sint32::sint32 (::bsint32) "BGL_BINT32_TO_INT32")
       ...
       (method static $sint64->bsint64::bsint64 (::sint64) "BGL_INT64_TO_BINT64")
       (method static $bsint64->sint64::sint64 (::bsint64) "BGL_BINT64_TO_INT64")
       ...
       (method static $uint8->sint8::sint8 (::uint8) "BGL_INT8_ID")
       (method static $sint8->uint8::uint8 (::sint8) "BGL_INT8_ID")
       (method static $uint16->sint16::sint16 (::uint16) "BGL_INT16_ID")
       (method static $sint16->uint16::uint16 (::sint16) "BGL_INT16_ID")
       (method static $uint32->sint32::sint32 (::uint32) "BGL_INT32_ID")
       (method static $sint32->uint32::uint32 (::sint32) "BGL_INT32_ID")
       (method static $uint64->sint64::sint64 (::uint64) "BGL_INT64_ID")
       (method static $sint64->uint64::uint64 (::sint64) "BGL_INT64_ID")
