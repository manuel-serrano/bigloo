...
;*     (coerce bint uint64 () ($bint->uint64))                         */
   ...
   (wasm
      ...
      ($byte->bint "(struct.new $bint (i64.extend_i32_s ~0))")
      ($ubyte->bint "(struct.new $bint (i64.extend_i32_u ~0))")
      ($short->bint "(struct.new $bint (i64.extend_i32_s ~0))")
      ...
      ($int16->bint "(struct.new $bint (i64.extend_i32_s ~0))")
      ($uint16->bint "(struct.new $bint (i64.extend_i32_u ~0))")
      ($int32->bint "(struct.new $bint (i64.extend_i32_s ~0))")
      ($uint32->bint "(struct.new $bint (i64.extend_i32_u ~0))")
      ($int64->bint "(struct.new $bint ~0)")
      ($uint64->bint "(struct.new $bint ~0)")
      
      ($bint->byte "(i32.wrap_i64 (struct.get $bint $v ~0))")
      ($bint->char "(i32.wrap_i64 (struct.get $bint $v ~0))")
      ($bint->ubyte "(i32.wrap_i64 (struct.get $bint $v ~0))")
      ($bint->short "(i32.wrap_i64 (struct.get $bint $v ~0))")
      ($bint->ushort "(i32.wrap_i64 (struct.get $bint $v ~0))")
      ($bint->int "(i32.wrap_i64 (struct.get $bint $v ~0))")
      ($bint->uint "(i32.wrap_i64 (struct.get $bint $v ~0))")
      ($bint->long "(struct.get $bint $v ~0)")
      ($bint->ulong "(struct.get $bint $v ~0)")
      ($bint->int8 "(i32.wrap_i64 (struct.get $bint $v ~0))")
      ($bint->uint8 "(i32.wrap_i64 (struct.get $bint $v ~0))")
      ($bint->int16 "(i32.wrap_i64 (struct.get $bint $v ~0))")
      ($bint->uint16 "(i32.wrap_i64 (struct.get $bint $v ~0))")
      ($bint->int32 "(i32.wrap_i64 (struct.get $bint $v ~0))")
      ($bint->uint32 "(i32.wrap_i64 (struct.get $bint $v ~0))")
      ($bint->int64 "(struct.get $bint $v ~0)")
      ($bint->uint64 "(struct.get $bint $v ~0)")
