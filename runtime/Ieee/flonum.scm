...
;*    Last change :  Fri Jun 10 10:49:09 2011 (serrano)                */
;*    -------------------------------------------------------------    */
...
(module __r4_numbers_6_5_flonum
   ...
   (pragma  (c-flonum? side-effect-free (predicate-of real) no-cfa-top nesting)
	    ...
	    (c-absfl side-effect-free no-cfa-top nesting args-safe)
	    (c-minfl side-effect-free no-cfa-top nesting args-safe)
	    (c-maxfl side-effect-free no-cfa-top nesting args-safe)
	    (c-signbit side-effect-free no-cfa-top nesting args-safe)
	    (c-roundfl side-effect-free no-cfa-top nesting args-safe)
	    (c-isnan side-effect-free no-cfa-top nesting args-safe)
	    (c-isinf side-effect-free no-cfa-top nesting args-safe)
	    (c-isfinite side-effect-free no-cfa-top nesting args-safe)
	    ...
	    (absfl side-effect-free no-cfa-top nesting)
	    (minfl side-effect-free no-cfa-top nesting)
	    (maxfl side-effect-free no-cfa-top nesting)
	    (signbitfl side-effect-free no-cfa-top nesting)
