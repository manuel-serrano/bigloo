...
;*    Last change :  Sun Sep 29 14:36:41 2013 (serrano)                */
;*    -------------------------------------------------------------    */
...
(module __r4_numbers_6_5_flonum
   ...
   (pragma  (c-flonum? side-effect-free (predicate-of real) no-cfa-top nesting fail-safe)
	    (real? side-effect-free no-cfa-top nesting fail-safe)
	    ...
	    (c-isnan side-effect-free no-cfa-top nesting args-safe fail-safe)
	    (c-isinf side-effect-free no-cfa-top nesting args-safe fail-safe)
	    (c-isfinite side-effect-free no-cfa-top nesting args-safe fail-safe)
	    (flonum? (predicate-of real) no-cfa-top nesting fail-safe)
	    (real? side-effect-free no-cfa-top nesting fail-safe)
	    ...
	    (integerfl? side-effect-free no-cfa-top nesting fail-safe)
	    (infinitefl? side-effect-free no-cfa-top nesting fail-safe)
	    (finitefl? side-effect-free no-cfa-top nesting fail-safe)
	    (nanfl? side-effect-free no-cfa-top nesting fail-safe)
