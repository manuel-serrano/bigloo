...
;*    Last change :  Tue Apr 25 14:35:34 2017 (serrano)                */
...
(define-macro (static v)
   ...
   (define (scm->c v)
	 ...
	 `(begin
	     ...
	     (pragma::vector ,(format "BVECTOR( &~a )" vname)))))
