...
;*    Last change :  Wed Jul  3 14:04:37 2024 (serrano)                */
;*    -------------------------------------------------------------    */
...
(module __r4_numbers_6_5_fixnum
   ...
   (wasm   ($fixnum? "(ref.test (ref $bint) ~0)")
	   ...
	   ($quotientfx "(i64.div_s ~0 ~1)")
	   ($quotientelong "(i64.div_s ~0 ~1)")
	   ($quotientllong "(i64.div_s ~0 ~1)")
	   ($quotients8 "(i32.div_s ~0 ~1)")
	   ($quotientu8 "(i32.div_u ~0 ~1)")
	   ($quotients16 "(i32.div_s ~0 ~1)")
	   ($quotientu16 "(i32.div_u ~0 ~1)")
	   ($quotients32 "(i32.div_s ~0 ~1)")
	   ($quotientu32 "(i32.div_u ~0 ~1)")
	   ($quotients64 "(i64.div_s ~0 ~1)")
	   ($quotientu64 "(i64.div_u ~0 ~1)")
	   ($remainderfx "(i64.rem_s ~0 ~1)")
	   ($remainderelong "(i64.rem_s ~0 ~1)")
	   ($remainderllong "(i64.rem_s ~0 ~1)")
	   ($remainders8 "(i32.rem_s ~0 ~1)")
	   ($remainderu8 "(i32.rem_u ~0 ~1)")
	   ($remainders16 "(i32.rem_s ~0 ~1)")
	   ($remainderu16 "(i32.rem_u ~0 ~1)")
