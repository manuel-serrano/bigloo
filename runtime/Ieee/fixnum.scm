...
(module __r4_numbers_6_5_fixnum
   ...
   (extern (macro $fixnum?::bool (::obj) "INTEGERP")
	   ...
	   (infix macro $=fx::bool (::long ::long) "==")
	   (infix macro $=elong::bool (::elong ::elong) "==")
	   (infix macro $=llong::bool (::llong ::llong) "==")
	   ...
	   (infix macro $/s64::int64 (::int64 ::int64) "/")
	   (infix macro $/u64::uint64 (::uint64 ::uint64) "/")
	   (macro $negfx::long (::long) "NEG")
	   (macro $negelong::elong (::elong) "NEG")
	   (macro $negllong::llong (::llong) "NEG")
	   (infix macro $quotientfx::long (::long ::long) "/")
	   (infix macro $quotientelong::elong (::elong ::elong) "/")
	   (infix macro $quotientllong::llong (::llong ::llong) "/")
	   ...
	   (infix macro $remainderfx::long (::long ::long) "%")
	   (infix macro $remainderelong::elong (::elong ::elong) "%")
	   (infix macro $remainderllong::llong (::llong ::llong) "%")
	   ...
	   ($elong->string::bstring  (::elong ::long) "integer_to_string")
	   ($llong->string::bstring  (::llong ::long) "llong_to_string")
   ...
   (java    (class foreign
		  ...
		  "EQ_ELONG")
	       (method static $=llong::bool (::llong ::llong)
		  "EQ_LLONG")
		  ...
		  "GE_INT64")
	       (method static $>=u64::bool (::uint64 ::uint64)
		  "GE_INT64")
	       (method static $evenfx?::bool (::long)
		  "EVENP_FX")
	       (method static $oddfx?::bool (::long)
		  "ODDP_FX")
	       (method static $+fx::long (::long ::long)
		  "PLUS_FX")
	       (method static $+elong::elong (::elong ::elong)
		  "PLUS_ELONG")
	       (method static $+llong::llong (::llong ::llong)
		  "PLUS_LLONG")
		  ...
		  "DIV_S64")
	       (method static $/u64::uint64 (::uint64 ::uint64)
		  "DIV_S64")
 	       (method static $negfx::long (::long)
		  "NEG_FX")
	       (method static $negelong::elong (::elong)
		  "NEG_ELONG")
	       (method static $negllong::llong (::llong)
		  "NEG_LLONG")
	       (method static $quotientfx::long (::long ::long)
		  "QUOTIENT_FX")
	       (method static $quotientelong::elong (::elong ::elong)
		  "QUOTIENT_ELONG")
	       (method static $quotientllong::llong (::llong ::llong)
		  "QUOTIENT_LLONG")
		  ...
		  "QUOTIENT_S64")
	       (method static $remainderfx::long (::long ::long)
		  "REMAINDER_FX")
	       (method static $remainderelong::elong (::elong ::elong)
		  "REMAINDER_ELONG")
	       (method static $remainderllong::llong (::llong ::llong)
		  "REMAINDER_LLONG")
		  ...
		  "strtoull")
	       (method static $fixnum->string::bstring (::long ::long)
		  "integer_to_string")
		  ...
		  "integer_to_string_padding")
	       ...
	       (method static $elong->string::bstring (::elong ::long)
		  "elong_to_string")
	       (method static $llong->string::bstring (::llong ::long)
		  "llong_to_string")
	       (method static $elong->string::bstring (::elong ::long)
		  "elong_to_string")
	       (method static $llong->string::bstring (::llong ::long)
   ...
   (pragma  (fixnum? no-alloc (predicate-of bint) no-cfa-top nesting fail-safe)
	    ...
	    ($*s64 no-alloc side-effect-free no-cfa-top nesting args-safe (effect) fail-safe)
	    ($*u64 no-alloc side-effect-free no-cfa-top nesting args-safe (effect) fail-safe)
 	    ($/fx no-alloc side-effect-free no-cfa-top nesting args-safe (effect))
	    ($/s8 no-alloc side-effect-free no-cfa-top nesting args-safe (effect) fail-safe)
	    ($/u8 no-alloc side-effect-free no-cfa-top nesting args-safe (effect) fail-safe)
	    ($/s16 no-alloc side-effect-free no-cfa-top nesting args-safe (effect) fail-safe)
	    ($/u16 no-alloc side-effect-free no-cfa-top nesting args-safe (effect) fail-safe)
