...
;*    Last change :  Fri Jan 31 11:38:04 2025 (serrano)                */
;*    -------------------------------------------------------------    */
...
(module __r4_numbers_6_5_fixnum
   ...
   (wasm   ($fixnum? "(call $INTEGERP ~0)")
	   ...
	   ($>=s64 "(i64.ge_s ~0 ~1)")
	   ($>=u64 "(i64.ge_u ~0 ~1)")
	   ; TODO: maybe use naive instructions for even and odd as JIT compilers will probably optimize them.
	   ($evenfx? "(i64.eqz (i64.and ~0 (i64.const 1)))")
	   ($oddfx? "(i64.eq (i64.and ~0 (i64.const 0x8000000000000001)) (i64.const 1))")
	   ($+fx "(i64.add ~0 ~1)")
	   ($+elong "(i64.add ~0 ~1)")
	   ($+llong "(i64.add ~0 ~1)")
	   ($+s8 "(i32.add ~0 ~1)")
	   ...
	   ($*s64 "(i64.mul ~0 ~1)")
	   ($*u64 "(i64.mul ~0 ~1)")
	   ($/fx "(i64.div_s ~0 (call $check_zero64 ~1))")
	   ($/elong "(i64.div_s ~0 (call $check_zero64 ~1))")
	   ($/llong "(i64.div_s ~0 (call $check_zero64 ~1))")
	   ($/s8 "(i32.div_s ~0 (call $check_zero32 ~1))")
	   ($/u8 "(i32.div_u ~0 (call $check_zero32 ~1))")
	   ($/s16 "(i32.div_s ~0 (call $check_zero32 ~1))")
	   ($/u16 "(i32.div_u ~0 (call $check_zero32 ~1))")
	   ($/s32 "(i32.div_s ~0 (call $check_zero32 ~1))")
	   ($/u32 "(i32.div_u ~0 (call $check_zero32 ~1))")
	   ($/s64 "(i64.div_s ~0 (call $check_zero64 ~1))")
	   ($/u64 "(i64.div_u ~0 (call $check_zero64 ~1))")
	   ($negfx "(i64.sub (i64.const 0) ~0)")
	   ($negelong "(i64.sub (i64.const 0) ~0)")
	   ($negllong "(i64.sub (i64.const 0) ~0)")
	   ($quotientfx "(i64.div_s ~0 (call $check_zero64 ~1))")
	   ($quotientelong "(i64.div_s ~0 (call $check_zero64 ~1))")
	   ($quotientllong "(i64.div_s ~0 (call $check_zero64 ~1))")
	   ($quotients8 "(i32.div_s ~0 (call $check_zero32 ~1))")
	   ($quotientu8 "(i32.div_u ~0 (call $check_zero32 ~1))")
	   ($quotients16 "(i32.div_s ~0 (call $check_zero32 ~1))")
	   ($quotientu16 "(i32.div_u ~0 (call $check_zero32 ~1))")
	   ($quotients32 "(i32.div_s ~0 (call $check_zero32 ~1))")
	   ($quotientu32 "(i32.div_u ~0 (call $check_zero32 ~1))")
	   ($quotients64 "(i64.div_s ~0 (call $check_zero64 ~1))")
	   ($quotientu64 "(i64.div_u ~0 (call $check_zero64 ~1))")
	   ($remainderfx "(i64.rem_s ~0 (call $check_zero64 ~1))")
	   ($remainderelong "(i64.rem_s ~0 (call $check_zero64 ~1))")
	   ($remainderllong "(i64.rem_s ~0 (call $check_zero64 ~1))")
	   ($remainders8 "(i32.rem_s ~0 (call $check_zero32 ~1))")
	   ($remainderu8 "(i32.rem_u ~0 (call $check_zero32 ~1))")
	   ($remainders16 "(i32.rem_s ~0 (call $check_zero32 ~1))")
	   ($remainderu16 "(i32.rem_u ~0 (call $check_zero32 ~1))")
	   ($remainders32 "(i32.rem_s ~0 (call $check_zero32 ~1))")
	   ($remainderu32 "(i32.rem_u ~0 (call $check_zero32 ~1))")
	   ($remainders64 "(i64.rem_s ~0 (call $check_zero64 ~1))")
	   ($remainderu64 "(i64.rem_u ~0 (call $check_zero64 ~1))"))
