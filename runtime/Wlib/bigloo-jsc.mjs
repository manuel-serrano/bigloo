/*=====================================================================*/
/*    serrano/prgm/project/bigloo/wasm/runtime/Wlib/bigloo-jsc.mjs     */
/*    -------------------------------------------------------------    */
/*    Author      :  manuel serrano                                    */
/*    Creation    :  Wed Sep  4 06:42:43 2024                          */
/*    Last change :  Tue Sep  9 18:02:30 2025 (serrano)                */
...
/*    BglJscRuntime                                                    */
/*---------------------------------------------------------------------*/
class BglJscRuntime extends BglRuntime {
...
async function runDynamic(client, rts, libs) {
   const __jsClient = new BglJscRuntime();
   const __jsLibs = libs.map(l => new BglJscRuntime());
   const __jsRts = new BglJscRuntime();
