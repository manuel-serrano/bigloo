...
;; Class accessors
;; Bigloo (4.6a)
;; Inria -- Sophia Antipolis     Wed Jun 26 03:22:32 PM CEST 2024 
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_reg::rtl_reg type1505::type var1506::obj onexpr?1507::obj name1508::obj key1509::obj debugname1510::obj hardware1511::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_retblock::rtl_retblock loc1492::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_ret::rtl_ret loc1488::obj to1489::block)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_notseq::rtl_notseq loc1486::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_if::rtl_if loc1484::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_select::rtl_select loc1480::obj type1481::type patterns1482::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_switch::rtl_switch loc1475::obj type1476::type patterns1477::obj labels1478::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_ifne::rtl_ifne loc1468::obj then1469::block)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_go::rtl_go loc1465::obj to1466::block)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_nop::rtl_nop loc1459::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_mov::rtl_mov loc1457::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_globalref::rtl_globalref loc1439::obj var1440::global)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_getfield::rtl_getfield loc1433::obj name1434::bstring objtype1435::type type1436::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_valloc::rtl_valloc loc1429::obj type1430::type vtype1431::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_vref::rtl_vref loc1425::obj type1426::type vtype1427::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_makebox::rtl_makebox loc1415::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_funcall::rtl_funcall loc1377::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_pragma::rtl_pragma loc1373::obj format1374::bstring srfi01375::symbol)
...
;; rtl_reg
(define-inline (make-rtl_reg::rtl_reg type1505::type var1506::obj onexpr?1507::obj name1508::obj key1509::obj debugname1510::obj hardware1511::obj) (instantiate::rtl_reg (type type1505) (var var1506) (onexpr? onexpr?1507) (name name1508) (key key1509) (debugname debugname1510) (hardware hardware1511)))
...
;; rtl_retblock
(define-inline (make-rtl_retblock::rtl_retblock loc1492::obj) (instantiate::rtl_retblock (loc loc1492)))
...
;; rtl_ret
(define-inline (make-rtl_ret::rtl_ret loc1488::obj to1489::block) (instantiate::rtl_ret (loc loc1488) (to to1489)))
...
;; rtl_notseq
(define-inline (make-rtl_notseq::rtl_notseq loc1486::obj) (instantiate::rtl_notseq (loc loc1486)))
...
;; rtl_if
(define-inline (make-rtl_if::rtl_if loc1484::obj) (instantiate::rtl_if (loc loc1484)))
...
;; rtl_select
(define-inline (make-rtl_select::rtl_select loc1480::obj type1481::type patterns1482::obj) (instantiate::rtl_select (loc loc1480) (type type1481) (patterns patterns1482)))
...
;; rtl_switch
(define-inline (make-rtl_switch::rtl_switch loc1475::obj type1476::type patterns1477::obj labels1478::obj) (instantiate::rtl_switch (loc loc1475) (type type1476) (patterns patterns1477) (labels labels1478)))
...
;; rtl_ifne
(define-inline (make-rtl_ifne::rtl_ifne loc1468::obj then1469::block) (instantiate::rtl_ifne (loc loc1468) (then then1469)))
...
;; rtl_go
(define-inline (make-rtl_go::rtl_go loc1465::obj to1466::block) (instantiate::rtl_go (loc loc1465) (to to1466)))
...
;; rtl_nop
(define-inline (make-rtl_nop::rtl_nop loc1459::obj) (instantiate::rtl_nop (loc loc1459)))
...
;; rtl_mov
(define-inline (make-rtl_mov::rtl_mov loc1457::obj) (instantiate::rtl_mov (loc loc1457)))
...
;; rtl_globalref
(define-inline (make-rtl_globalref::rtl_globalref loc1439::obj var1440::global) (instantiate::rtl_globalref (loc loc1439) (var var1440)))
...
;; rtl_getfield
(define-inline (make-rtl_getfield::rtl_getfield loc1433::obj name1434::bstring objtype1435::type type1436::type) (instantiate::rtl_getfield (loc loc1433) (name name1434) (objtype objtype1435) (type type1436)))
...
;; rtl_valloc
(define-inline (make-rtl_valloc::rtl_valloc loc1429::obj type1430::type vtype1431::type) (instantiate::rtl_valloc (loc loc1429) (type type1430) (vtype vtype1431)))
...
;; rtl_vref
(define-inline (make-rtl_vref::rtl_vref loc1425::obj type1426::type vtype1427::type) (instantiate::rtl_vref (loc loc1425) (type type1426) (vtype vtype1427)))
...
;; rtl_makebox
(define-inline (make-rtl_makebox::rtl_makebox loc1415::obj) (instantiate::rtl_makebox (loc loc1415)))
...
;; rtl_funcall
(define-inline (make-rtl_funcall::rtl_funcall loc1377::obj) (instantiate::rtl_funcall (loc loc1377)))
...
;; rtl_pragma
(define-inline (make-rtl_pragma::rtl_pragma loc1373::obj format1374::bstring srfi01375::symbol) (instantiate::rtl_pragma (loc loc1373) (format format1374) (srfi0 srfi01375)))
