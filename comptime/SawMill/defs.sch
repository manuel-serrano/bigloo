...
;; Class accessors
;; Bigloo (4.5b)
;; Inria -- Sophia Antipolis     Mon Sep 18 02:15:44 PM CEST 2023 
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_reg::rtl_reg type1510::type var1511::obj onexpr?1512::obj name1513::obj key1514::obj debugname1515::obj hardware1516::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_fun::rtl_fun loc1507::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_last::rtl_last loc1505::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_return::rtl_return loc1502::obj type1503::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_jumpexit::rtl_jumpexit loc1499::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_ret::rtl_ret loc1491::obj to1492::block)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_ifeq::rtl_ifeq loc1473::obj then1474::block)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_ifne::rtl_ifne loc1469::obj then1470::block)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_go::rtl_go loc1466::obj to1467::block)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_pure::rtl_pure loc1463::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_nop::rtl_nop loc1460::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_mov::rtl_mov loc1458::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_loadi::rtl_loadi loc1455::obj constant1456::atom)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_loadg::rtl_loadg loc1451::obj var1453::global)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_loadfun::rtl_loadfun loc1447::obj var1448::global)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_globalref::rtl_globalref loc1443::obj var1445::global)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_getfield::rtl_getfield loc1438::obj name1439::bstring objtype1440::type type1441::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_valloc::rtl_valloc loc1432::obj type1433::type vtype1434::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_vref::rtl_vref loc1428::obj type1429::type vtype1430::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_vlength::rtl_vlength loc1424::obj type1425::type vtype1426::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_instanceof::rtl_instanceof loc1421::obj type1422::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_makebox::rtl_makebox loc1419::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_boxref::rtl_boxref loc1416::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_effect::rtl_effect loc1414::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_storeg::rtl_storeg loc1411::obj var1412::global)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_setfield::rtl_setfield loc1405::obj name1406::bstring objtype1407::type type1408::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_vset::rtl_vset loc1400::obj type1401::type vtype1402::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_boxset::rtl_boxset loc1397::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_new::rtl_new loc1393::obj type1394::type constr1395::pair-nil)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_call::rtl_call loc1389::obj var1390::global)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_funcall::rtl_funcall loc1379::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_pragma::rtl_pragma loc1376::obj format1377::bstring)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_cast::rtl_cast loc1372::obj totype1373::type fromtype1374::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_cast_null::rtl_cast_null loc1368::obj type1369::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_protect::rtl_protect loc1365::obj)
...
;; rtl_reg
(define-inline (make-rtl_reg::rtl_reg type1510::type var1511::obj onexpr?1512::obj name1513::obj key1514::obj debugname1515::obj hardware1516::obj) (instantiate::rtl_reg (type type1510) (var var1511) (onexpr? onexpr?1512) (name name1513) (key key1514) (debugname debugname1515) (hardware hardware1516)))
...
;; rtl_fun
(define-inline (make-rtl_fun::rtl_fun loc1507::obj) (instantiate::rtl_fun (loc loc1507)))
...
;; rtl_last
(define-inline (make-rtl_last::rtl_last loc1505::obj) (instantiate::rtl_last (loc loc1505)))
...
;; rtl_return
(define-inline (make-rtl_return::rtl_return loc1502::obj type1503::type) (instantiate::rtl_return (loc loc1502) (type type1503)))
...
;; rtl_jumpexit
(define-inline (make-rtl_jumpexit::rtl_jumpexit loc1499::obj) (instantiate::rtl_jumpexit (loc loc1499)))
...
;; rtl_ret
(define-inline (make-rtl_ret::rtl_ret loc1491::obj to1492::block) (instantiate::rtl_ret (loc loc1491) (to to1492)))
...
;; rtl_ifeq
(define-inline (make-rtl_ifeq::rtl_ifeq loc1473::obj then1474::block) (instantiate::rtl_ifeq (loc loc1473) (then then1474)))
...
;; rtl_ifne
(define-inline (make-rtl_ifne::rtl_ifne loc1469::obj then1470::block) (instantiate::rtl_ifne (loc loc1469) (then then1470)))
...
;; rtl_go
(define-inline (make-rtl_go::rtl_go loc1466::obj to1467::block) (instantiate::rtl_go (loc loc1466) (to to1467)))
...
;; rtl_pure
(define-inline (make-rtl_pure::rtl_pure loc1463::obj) (instantiate::rtl_pure (loc loc1463)))
...
;; rtl_nop
(define-inline (make-rtl_nop::rtl_nop loc1460::obj) (instantiate::rtl_nop (loc loc1460)))
...
;; rtl_mov
(define-inline (make-rtl_mov::rtl_mov loc1458::obj) (instantiate::rtl_mov (loc loc1458)))
...
;; rtl_loadi
(define-inline (make-rtl_loadi::rtl_loadi loc1455::obj constant1456::atom) (instantiate::rtl_loadi (loc loc1455) (constant constant1456)))
...
;; rtl_loadg
(define-inline (make-rtl_loadg::rtl_loadg loc1451::obj var1453::global) (instantiate::rtl_loadg (loc loc1451) (var var1453)))
...
;; rtl_loadfun
(define-inline (make-rtl_loadfun::rtl_loadfun loc1447::obj var1448::global) (instantiate::rtl_loadfun (loc loc1447) (var var1448)))
...
;; rtl_globalref
(define-inline (make-rtl_globalref::rtl_globalref loc1443::obj var1445::global) (instantiate::rtl_globalref (loc loc1443) (var var1445)))
...
;; rtl_getfield
(define-inline (make-rtl_getfield::rtl_getfield loc1438::obj name1439::bstring objtype1440::type type1441::type) (instantiate::rtl_getfield (loc loc1438) (name name1439) (objtype objtype1440) (type type1441)))
...
;; rtl_valloc
(define-inline (make-rtl_valloc::rtl_valloc loc1432::obj type1433::type vtype1434::type) (instantiate::rtl_valloc (loc loc1432) (type type1433) (vtype vtype1434)))
...
;; rtl_vref
(define-inline (make-rtl_vref::rtl_vref loc1428::obj type1429::type vtype1430::type) (instantiate::rtl_vref (loc loc1428) (type type1429) (vtype vtype1430)))
...
;; rtl_vlength
(define-inline (make-rtl_vlength::rtl_vlength loc1424::obj type1425::type vtype1426::type) (instantiate::rtl_vlength (loc loc1424) (type type1425) (vtype vtype1426)))
...
;; rtl_instanceof
(define-inline (make-rtl_instanceof::rtl_instanceof loc1421::obj type1422::type) (instantiate::rtl_instanceof (loc loc1421) (type type1422)))
...
;; rtl_makebox
(define-inline (make-rtl_makebox::rtl_makebox loc1419::obj) (instantiate::rtl_makebox (loc loc1419)))
...
;; rtl_boxref
(define-inline (make-rtl_boxref::rtl_boxref loc1416::obj) (instantiate::rtl_boxref (loc loc1416)))
...
;; rtl_effect
(define-inline (make-rtl_effect::rtl_effect loc1414::obj) (instantiate::rtl_effect (loc loc1414)))
...
;; rtl_storeg
(define-inline (make-rtl_storeg::rtl_storeg loc1411::obj var1412::global) (instantiate::rtl_storeg (loc loc1411) (var var1412)))
...
;; rtl_setfield
(define-inline (make-rtl_setfield::rtl_setfield loc1405::obj name1406::bstring objtype1407::type type1408::type) (instantiate::rtl_setfield (loc loc1405) (name name1406) (objtype objtype1407) (type type1408)))
...
;; rtl_vset
(define-inline (make-rtl_vset::rtl_vset loc1400::obj type1401::type vtype1402::type) (instantiate::rtl_vset (loc loc1400) (type type1401) (vtype vtype1402)))
...
;; rtl_boxset
(define-inline (make-rtl_boxset::rtl_boxset loc1397::obj) (instantiate::rtl_boxset (loc loc1397)))
...
;; rtl_new
(define-inline (make-rtl_new::rtl_new loc1393::obj type1394::type constr1395::pair-nil) (instantiate::rtl_new (loc loc1393) (type type1394) (constr constr1395)))
...
;; rtl_call
(define-inline (make-rtl_call::rtl_call loc1389::obj var1390::global) (instantiate::rtl_call (loc loc1389) (var var1390)))
...
;; rtl_funcall
(define-inline (make-rtl_funcall::rtl_funcall loc1379::obj) (instantiate::rtl_funcall (loc loc1379)))
...
;; rtl_pragma
(define-inline (make-rtl_pragma::rtl_pragma loc1376::obj format1377::bstring) (instantiate::rtl_pragma (loc loc1376) (format format1377)))
...
;; rtl_cast
(define-inline (make-rtl_cast::rtl_cast loc1372::obj totype1373::type fromtype1374::type) (instantiate::rtl_cast (loc loc1372) (totype totype1373) (fromtype fromtype1374)))
...
;; rtl_cast_null
(define-inline (make-rtl_cast_null::rtl_cast_null loc1368::obj type1369::type) (instantiate::rtl_cast_null (loc loc1368) (type type1369)))
...
;; rtl_protect
(define-inline (make-rtl_protect::rtl_protect loc1365::obj) (instantiate::rtl_protect (loc loc1365)))
