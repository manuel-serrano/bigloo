...
;; Class accessors
;; Bigloo (4.7a)
;; Inria -- Sophia Antipolis     Tue Sep 9 05:08:14 PM CEST 2025 
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_reg::rtl_reg type1514::type var1515::obj onexpr?1516::obj name1517::obj key1518::obj debugname1519::obj hardware1520::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_retblock::rtl_retblock loc1501::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_ret::rtl_ret loc1496::obj to1497::block)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_notseq::rtl_notseq loc1494::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_if::rtl_if loc1492::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_select::rtl_select loc1488::obj type1489::type patterns1490::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_switch::rtl_switch loc1482::obj type1483::type patterns1484::obj labels1485::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_ifeq::rtl_ifeq loc1478::obj then1479::block)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_ifne::rtl_ifne loc1475::obj then1476::block)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_go::rtl_go loc1471::obj to1472::block)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_pure::rtl_pure loc1467::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_nop::rtl_nop loc1465::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_mov::rtl_mov loc1461::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_loadi::rtl_loadi loc1457::obj constant1458::atom)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_loadg::rtl_loadg loc1452::obj var1453::global)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_loadfun::rtl_loadfun loc1449::obj var1450::global)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_globalref::rtl_globalref loc1444::obj var1446::global)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_getfield::rtl_getfield loc1437::obj name1438::bstring objtype1439::type type1440::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_valloc::rtl_valloc loc1431::obj type1432::type vtype1433::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_vref::rtl_vref loc1427::obj type1428::type vtype1429::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_vlength::rtl_vlength loc1422::obj type1423::type vtype1424::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_instanceof::rtl_instanceof loc1417::obj type1418::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_boxref::rtl_boxref loc1411::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_effect::rtl_effect loc1408::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_storeg::rtl_storeg loc1405::obj var1406::global)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_setfield::rtl_setfield loc1400::obj name1401::bstring objtype1402::type type1403::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_call::rtl_call loc1387::obj var1388::global)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_apply::rtl_apply loc1385::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_lightfuncall::rtl_lightfuncall loc1380::obj name1381::symbol funs1382::pair-nil rettype1383::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_funcall::rtl_funcall loc1377::obj rettype1378::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_pragma::rtl_pragma loc1372::obj type1373::type format1374::bstring srfi01375::symbol)
    ...
    (inline rtl_pragma-type::type ::rtl_pragma)
    (inline rtl_pragma-type-set! ::rtl_pragma ::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_cast::rtl_cast loc1368::obj totype1369::type fromtype1370::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_cast_null::rtl_cast_null loc1365::obj type1366::type)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_protected::rtl_protected loc1361::obj)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-rtl_ins::rtl_ins loc1355::obj %spill1356::pair-nil dest1357::obj fun1358::rtl_fun args1359::pair-nil)
...
(cond-expand ((and bigloo-class-sans (not bigloo-class-generate))
  (export
    (inline make-block::block label1350::int preds1351::pair-nil succs1352::pair-nil first1353::pair-nil)
...
;; rtl_reg
(define-inline (make-rtl_reg::rtl_reg type1514::type var1515::obj onexpr?1516::obj name1517::obj key1518::obj debugname1519::obj hardware1520::obj) (instantiate::rtl_reg (type type1514) (var var1515) (onexpr? onexpr?1516) (name name1517) (key key1518) (debugname debugname1519) (hardware hardware1520)))
...
;; rtl_retblock
(define-inline (make-rtl_retblock::rtl_retblock loc1501::obj) (instantiate::rtl_retblock (loc loc1501)))
...
;; rtl_ret
(define-inline (make-rtl_ret::rtl_ret loc1496::obj to1497::block) (instantiate::rtl_ret (loc loc1496) (to to1497)))
...
;; rtl_notseq
(define-inline (make-rtl_notseq::rtl_notseq loc1494::obj) (instantiate::rtl_notseq (loc loc1494)))
...
;; rtl_if
(define-inline (make-rtl_if::rtl_if loc1492::obj) (instantiate::rtl_if (loc loc1492)))
...
;; rtl_select
(define-inline (make-rtl_select::rtl_select loc1488::obj type1489::type patterns1490::obj) (instantiate::rtl_select (loc loc1488) (type type1489) (patterns patterns1490)))
...
;; rtl_switch
(define-inline (make-rtl_switch::rtl_switch loc1482::obj type1483::type patterns1484::obj labels1485::obj) (instantiate::rtl_switch (loc loc1482) (type type1483) (patterns patterns1484) (labels labels1485)))
...
;; rtl_ifeq
(define-inline (make-rtl_ifeq::rtl_ifeq loc1478::obj then1479::block) (instantiate::rtl_ifeq (loc loc1478) (then then1479)))
...
;; rtl_ifne
(define-inline (make-rtl_ifne::rtl_ifne loc1475::obj then1476::block) (instantiate::rtl_ifne (loc loc1475) (then then1476)))
...
;; rtl_go
(define-inline (make-rtl_go::rtl_go loc1471::obj to1472::block) (instantiate::rtl_go (loc loc1471) (to to1472)))
...
;; rtl_pure
(define-inline (make-rtl_pure::rtl_pure loc1467::obj) (instantiate::rtl_pure (loc loc1467)))
...
;; rtl_nop
(define-inline (make-rtl_nop::rtl_nop loc1465::obj) (instantiate::rtl_nop (loc loc1465)))
...
;; rtl_mov
(define-inline (make-rtl_mov::rtl_mov loc1461::obj) (instantiate::rtl_mov (loc loc1461)))
...
;; rtl_loadi
(define-inline (make-rtl_loadi::rtl_loadi loc1457::obj constant1458::atom) (instantiate::rtl_loadi (loc loc1457) (constant constant1458)))
...
;; rtl_loadg
(define-inline (make-rtl_loadg::rtl_loadg loc1452::obj var1453::global) (instantiate::rtl_loadg (loc loc1452) (var var1453)))
...
;; rtl_loadfun
(define-inline (make-rtl_loadfun::rtl_loadfun loc1449::obj var1450::global) (instantiate::rtl_loadfun (loc loc1449) (var var1450)))
...
;; rtl_globalref
(define-inline (make-rtl_globalref::rtl_globalref loc1444::obj var1446::global) (instantiate::rtl_globalref (loc loc1444) (var var1446)))
...
;; rtl_getfield
(define-inline (make-rtl_getfield::rtl_getfield loc1437::obj name1438::bstring objtype1439::type type1440::type) (instantiate::rtl_getfield (loc loc1437) (name name1438) (objtype objtype1439) (type type1440)))
...
;; rtl_valloc
(define-inline (make-rtl_valloc::rtl_valloc loc1431::obj type1432::type vtype1433::type) (instantiate::rtl_valloc (loc loc1431) (type type1432) (vtype vtype1433)))
...
;; rtl_vref
(define-inline (make-rtl_vref::rtl_vref loc1427::obj type1428::type vtype1429::type) (instantiate::rtl_vref (loc loc1427) (type type1428) (vtype vtype1429)))
...
;; rtl_vlength
(define-inline (make-rtl_vlength::rtl_vlength loc1422::obj type1423::type vtype1424::type) (instantiate::rtl_vlength (loc loc1422) (type type1423) (vtype vtype1424)))
...
;; rtl_instanceof
(define-inline (make-rtl_instanceof::rtl_instanceof loc1417::obj type1418::type) (instantiate::rtl_instanceof (loc loc1417) (type type1418)))
...
;; rtl_boxref
(define-inline (make-rtl_boxref::rtl_boxref loc1411::obj) (instantiate::rtl_boxref (loc loc1411)))
...
;; rtl_effect
(define-inline (make-rtl_effect::rtl_effect loc1408::obj) (instantiate::rtl_effect (loc loc1408)))
...
;; rtl_storeg
(define-inline (make-rtl_storeg::rtl_storeg loc1405::obj var1406::global) (instantiate::rtl_storeg (loc loc1405) (var var1406)))
...
;; rtl_setfield
(define-inline (make-rtl_setfield::rtl_setfield loc1400::obj name1401::bstring objtype1402::type type1403::type) (instantiate::rtl_setfield (loc loc1400) (name name1401) (objtype objtype1402) (type type1403)))
...
;; rtl_call
(define-inline (make-rtl_call::rtl_call loc1387::obj var1388::global) (instantiate::rtl_call (loc loc1387) (var var1388)))
...
;; rtl_apply
(define-inline (make-rtl_apply::rtl_apply loc1385::obj) (instantiate::rtl_apply (loc loc1385)))
...
;; rtl_lightfuncall
(define-inline (make-rtl_lightfuncall::rtl_lightfuncall loc1380::obj name1381::symbol funs1382::pair-nil rettype1383::obj) (instantiate::rtl_lightfuncall (loc loc1380) (name name1381) (funs funs1382) (rettype rettype1383)))
...
;; rtl_funcall
(define-inline (make-rtl_funcall::rtl_funcall loc1377::obj rettype1378::obj) (instantiate::rtl_funcall (loc loc1377) (rettype rettype1378)))
...
;; rtl_pragma
(define-inline (make-rtl_pragma::rtl_pragma loc1372::obj type1373::type format1374::bstring srfi01375::symbol) (instantiate::rtl_pragma (loc loc1372) (type type1373) (format format1374) (srfi0 srfi01375)))
...
(define-inline (rtl_pragma-type::type o::rtl_pragma) (-> |#!bigloo_wallow| o type))
(define-inline (rtl_pragma-type-set! o::rtl_pragma v::type) (set! (-> |#!bigloo_wallow| o type) v))
...
;; rtl_cast
(define-inline (make-rtl_cast::rtl_cast loc1368::obj totype1369::type fromtype1370::type) (instantiate::rtl_cast (loc loc1368) (totype totype1369) (fromtype fromtype1370)))
...
;; rtl_cast_null
(define-inline (make-rtl_cast_null::rtl_cast_null loc1365::obj type1366::type) (instantiate::rtl_cast_null (loc loc1365) (type type1366)))
...
;; rtl_protected
(define-inline (make-rtl_protected::rtl_protected loc1361::obj) (instantiate::rtl_protected (loc loc1361)))
...
;; rtl_ins
(define-inline (make-rtl_ins::rtl_ins loc1355::obj %spill1356::pair-nil dest1357::obj fun1358::rtl_fun args1359::pair-nil) (instantiate::rtl_ins (loc loc1355) (%spill %spill1356) (dest dest1357) (fun fun1358) (args args1359)))
...
;; block
(define-inline (make-block::block label1350::int preds1351::pair-nil succs1352::pair-nil first1353::pair-nil) (instantiate::block (label label1350) (preds preds1351) (succs succs1352) (first first1353)))
