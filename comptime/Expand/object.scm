...
;*---------------------------------------------------------------------*/
;*    expand-class-allocate ...                                        */
;*    -------------------------------------------------------------    */
;*    This form is only generated by the module5 macro-expander of     */
;*    instantiate::xxx. It is not a public form (see runtime/module5). */
;*---------------------------------------------------------------------*/
