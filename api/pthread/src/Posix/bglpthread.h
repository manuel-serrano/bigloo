/*=====================================================================*/
/*    .../project/bigloo/5.0.x/api/pthread/src/Posix/bglpthread.h      */
/*    -------------------------------------------------------------    */
/*    Author      :  Manuel Serrano                                    */
/*    Creation    :  Fri Feb 22 11:01:20 2002                          */
/*    Last change :  Thu May 28 08:13:04 2026 (serrano)                */
...
#if(BGL_HAVE_SEMAPHORE)
#  define BGL_SEMAPHORE_DELETE(s) sem_unlink(BSTRING_TO_STRING(BGL_SEMAPHORE_NAME(s)))
#else
#  define BGL_SEMAPHORE_DELETE(s) -1
#endif
