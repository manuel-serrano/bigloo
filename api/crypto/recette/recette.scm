...
;*    Last change :  Mon Jul 18 09:32:24 2011 (serrano)                */
	   ...
	   (lambda ()
		 ...
		 (and (= (Rsa-Key-modulus *rsa-key*)
			 #)
		      (= (Rsa-Key-exponent *public-rsa-key*)
			 #z65537)
		      (= (Rsa-Key-exponent *private-rsa-key*)
...
(test-add! 'elgamal-encryption
	   (lambda ()
	      (let* ((elgamal-key (make-Complete-ElGamal-Key
				   #
				   #z6
				   #
				   #z2134518737763899887266634226677740732927868102526427119184291457116975686455967173260409051058440567651))
