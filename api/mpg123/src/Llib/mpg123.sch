...
;*    Last change :  Sun Jun 26 15:46:25 2011 (serrano)                */
...
(directives
   (extern
    ...
    (macro $mpg123-init::int () "mpg123_init")
    (macro $mpg123-exit::void () "mpg123_void")
    (macro $mpg123-open-feed::int (::$mpg123-handle) "mpg123_open_feed")
    (macro $mpg123-delete::void (::$mpg123-handle) "mpg123_delete")
    (macro $mpg123-current-decoder::string (::$mpg123-handle) "mpg123_current_decoder")
    (macro $mpg123-plain-strerror::string (::int) "mpg123_plain_strerror")
    (macro $mpg123-length::long (::$mpg123-handle) "mpg123_length")
    (macro $mpg123-tpf::double (::$mpg123-handle) "mpg123_tpf")
    (macro $mpg123-tell::long (::$mpg123-handle) "mpg123_tell")
    
    ($bgl-mpg123-decode::int (::$mpg123-handle ::string ::long ::string ::long) "bgl_mpg123_decode")
    ($bgl-mpg123-new::$mpg123-handle (::string) "bgl_mpg123_new")
    ($bgl-mpg123-decoders::pair-nil () "bgl_mpg123_decoders")
    ($bgl-mpg123-get-format::long (::$mpg123-handle) "bgl_mpg123_getformat")
    ($bgl-mpg123-position::long (::$mpg123-handle) "bgl_mpg123_position")
