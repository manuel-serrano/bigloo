/*=====================================================================*/
/*    .../project/bigloo/bigloo/api/mpg123/src/Clib/bglmpg123.c        */
/*    -------------------------------------------------------------    */
/*    Author      :  Manuel Serrano                                    */
/*    Creation    :  Mon Jun 20 14:50:56 2011                          */
/*    Last change :  Fri Dec  8 19:28:32 2023 (serrano)                */
...
bgl_mpg123_new(const char *decoder) {
   ...
   if (!m) {
      bgl_mpg123_error(
	 "bgl-mpg123-new",
	 (char *)mpg123_plain_strerror(err),
...
bgl_mpg123_decode(obj_t o, char *inbuf, long offset, long insz, char *outbuf, long outsz) {
   ...
   ret = mpg123_decode(m, insz ? (const unsigned char *)(inbuf + offset) : 0L, insz, outbuf, outsz, &size);
...
bgl_mpg123_info(obj_t o) {
   ...
   if (err < 0) {
      bgl_mpg123_error("mpg123-info", (char *)mpg123_plain_strerror(err), o);
   }
...
bgl_mpg123_getparam(obj_t o, enum mpg123_parms type) {
   ...
   if (err < 0) {
      bgl_mpg123_error("mpg123-getparam", (char *)mpg123_plain_strerror(err), o);
   }
