;*=====================================================================*/
;*    .../prgm/project/bigloo/wasm/api/sqlite/src/Llib/sqlite.sch      */
;*    -------------------------------------------------------------    */
;*    Author      :  Manuel Serrano                                    */
;*    Creation    :  Thu Nov 10 14:23:34 2005                          */
;*    Last change :  Tue Sep  9 10:04:26 2025 (serrano)                */
...
(directives
   ...
   (cond-expand
      (bigloo-c
       (extern (infix macro $_sqlite-nil::$sqlite () "0L")))
      (bigloo-wasm
       (extern (macro $_sqlite-nil::$sqlite () "bgl_sqlite_nil")))))
