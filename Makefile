...
boot-bde:
	$(MAKE) -C bde boot BFLAGS="$(BFLAGS) $(SHRD_BDE_OPT)" WASMBACKEND=$(WASMBACKEND)
...
dohostboot:
	...
	$(MAKE) -C bde clean BIGLOO=$(BOOTBINDIR)/bigloo
...
fullbootstrap-sans-log:
	...
	$(MAKE) -C test clean && $(MAKE) -C test check && $(MAKE) -C test clean
