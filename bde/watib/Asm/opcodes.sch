...
`((unreachable . "\x00")
  ...
  (i64.load     . "\x29\x03\x00")
  (f32.load     . "\x2A\x02\x00")
  (f64.load     . "\x2B\x03\x00")
  (i32.load8_s  . "\x2C\x00\x00")
  (i32.load8_u  . "\x2D\x00\x00")
  (i32.load16_s . "\x2E\x01\x00")
  (i32.load16_u . "\x2F\x01\x00")
  (i64.load8_s  . "\x30\x00\x00")
  (i64.load8_u  . "\x31\x00\x00")
  (i64.load16_s . "\32\x01\x00")
  (i64.load16_u . "\x33\x01\x00")
  (i64.load32_s . "\x34\x02\x00")
  (i64.load32_u . "\x35\x02\x00")
  (i32.store    . "\x36\x02\x00")
  (i64.store    . "\x37\x03\x00")
  (f32.store    . "\x38\x02\x00")
  (f64.store    . "\x39\x03\x00")
  (i32.store8   . "\x3A\x00\x00")
  (i32.store16  . "\x3B\x01\x00")
  (i64.store8   . "\x3C\x00\x00")
  (i64.store16  . "\x3D\x01\x00")
  (i64.store32  . "\x3E\x02\x00")
  (memory.size  . "\x3F\x00")
  (memory.grow  . "\x40\x00"))
